...
var INRstarV5 = set_system();
    ...
    var panelMCP = INRstarV5.Panel("MainPage").Panel("main").Panel("MainContentPanel");
    WaitSeconds(1);
    var panelPMTC = panelMCP.Panel("PatientRecord").Panel("PatientMainTabContent").Panel("PatientTabContent").Panel(0).Panel(0);
    panelPMTC.Form("AddReviewForm").Panel(0).Panel("AnnualReviewAddActions").Button("CancelWarfarinReviewLink").Click();
}
