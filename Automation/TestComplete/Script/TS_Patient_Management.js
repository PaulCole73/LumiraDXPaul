...
function ts_int_regression_patient_management(send_mail)
{
  reset_folder();
...
//==============================================================================//
//regression suites are used for specific regression runs 
function ts_int_regression_patient_management_italy(send_mail)
{
  reset_folder();
  ...
  email_and_archive(send_mail, "ts_pat_manage_regression_ita");
}
//==============================================================================//
