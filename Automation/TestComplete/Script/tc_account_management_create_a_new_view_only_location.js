...
function tc_account_management_create_a_new_view_only_location()
{
  try
  {
    var test_title = "Admin Dashboard - Account Management - Create a new view only location";
    login_admin_dash();
  ...
  catch(e)
  {
    ...
    var suite_name = "tc_account_management_create_a_new_view_only_location";
    var test_name = "tc_account_management_create_a_new_view_only_location";
