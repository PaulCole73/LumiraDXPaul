...
{
  var main = Sys.Browser("iexplore").Page("https://admin-tatooine.lumiradxcaresolutions.com/");
  return main;
}
function admin_dash_login_base()
{
  var main = Sys.Browser("iexplore").Page("https://admin-tatooine.lumiradxcaresolutions.com/Security/Authentication/LogOn?ReturnUrl=%2f");
  return main;
}
//------------------------------------------------------------------------
