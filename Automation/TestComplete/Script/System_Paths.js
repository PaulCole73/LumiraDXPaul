...
function login_page_version_number()
{
  var base = INRstar_base().Panel("MainPage").Panel("main");
...
function treatment_inr_test_options()
{
  ...
  {
   var inr_options_path = panelPTNIW.Panel("PatientTreatmentNewINRQuestionsWrapper").Panel("PatientTreatmentNewINRTestDetails").Panel("testDetails").Fieldset("Options"); 
  }
