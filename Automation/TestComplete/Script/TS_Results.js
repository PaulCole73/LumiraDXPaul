...
{ 
  ...
  tc_inrstarid_used_as_patient_identifier_results_are_rejected_from_inrstar_if_organizationid_is_unknown_to_inrstar_where_id_does_not_match_a_patient_in_the_database(); //Should also generate an email note responses: UK=500 Italy:404
  ...
  tc_nhs_or_fiscal_used_as_patient_identifier_results_are_rejected_from_inrstar_if_organizationid_is_unknown_to_inrstar(); //Should also generate an email note responses: UK=500 Italy:404
}
//==============================================================================//