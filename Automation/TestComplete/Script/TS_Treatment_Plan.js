...
function ts_int_regression_treatment_plan(send_mail)
{
  reset_folder();
...
//==============================================================================//
function ts_int_regression_treatment_plan_italy(send_mail)
{
  reset_folder();
  ...
  email_and_archive(send_mail, "ts_tp_regression_ita");
}
//==============================================================================//
