...
{
      Step_4_2_1_Add_TreatmentPlan_No_Treatments();
      Step_4_2_1_1_Edit_TreatmentPlan_No_Treatments();
      Step_4_2_2_Add_TreatmentPlan_With_Treatment(); 
      Step_4_2_3_Edit_TreatmentPlan_Treatments();
      Step_4_2_4_Add_TreatmentPlan_Unknown_Diagnosis();
      Step_4_2_5_Add_TreatmentPlan_Future_Appointment();
      Step_4_2_6_Change_Dose_Method();
}        
//===============================================================================       
...
function Step_4_2_6_Change_Dose_Method()
{
  ...
  var text=INRstarV5.Panel(2).Panel("modalDialogBox").Panel(0).Label("AlgorithmInformation_DetachedLabel").innerText;
