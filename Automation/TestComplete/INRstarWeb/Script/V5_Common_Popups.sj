...
//-------------------------------------------------------------------------------
// Process Confirm window
function process_confirm_change_registered_location(INRstarV5)
{
...
function process_confirm_button(INRstarV5)
{
...
//-------------------------------------------------------------------------------
// Click OK button
function process_Ok(InnerText)
{
  // Find the Panel
  var INRstarV5 = set_system();
  var w_popup = INRstarV5.NativeWebObject.Find("innerText", InnerText);
  if (w_popup.Exists == false)
  {
         Log.Warning("'" + InnerText + "' box not displayed");
  }
  else
  {
//     Log.Message("'" + InnerText + "' box displayed");
     // Find the button
     var wbt_OK = INRstarV5.NativeWebObject.Find("innerText", "OK");
     if (wbt_OK.Exists == false || wbt_OK.Visible == false)
     {
        Log.Warning("'" + InnerText + "' OK button not found");
     }
     else
     {
        WaitSeconds(1);
//        Log.Message("Clicking '" + InnerText + "' OK button ");
        INRstarV5.Panel(2).Panel(1).Panel(0).Button(1).Click();
    }
  }     
} 
...
function process_button(INRstarV5, w_hdg, p_ans)
{
  ...
  else
  {
     ...
     {
        Log.Warning("'" + w_hdg + "'" + p_ans + " button not found");
     }
     else
     {
        WaitSeconds(1);
        //Log.Message("Clicking '" + w_hdg + "' " + p_ans + "  button ");
//        INRstarV5.Panel(2).Panel(1).Panel(0).Button(1).Click();
...
function process_confirm_INR_cancel(INRstarV5)
{
  var INRstarV5 = set_system();
  var w_hdg = "Confirmation Required";
...
function process_Please_acknowledge(INRstarV5)
{
  WaitSeconds(2,"");
...
//-------------------------------------------------------------------------------
// Process Out-of-range INR
function process_Please_acknowledge_warnings(INRstarV5)
{
  WaitSeconds(5,"Before clicking 'Please acknowledge'");
...
//        {
          Log.Message("Clicking '" + w_hdg + "' Confirm button ")
          INRstarV5.Panel(3).Panel(1).Panel(0).Button(0).Click();
//        INRstarV5.Panel(1).Panel(1).Panel(0).Button(0).Click();
//        }
     } 
  }   
    WaitSeconds(5,"After clicking 'Please acknowledge'");
}  
//-------------------------------------------------------------------------------
...
//-------------------------------------------------------------------------------
// Process Out-of-range INR
function process_confirm_delete_adverse_event(INRstarV5)
{
  WaitSeconds(2,"");
...
function process_more_information(INRstarV5)
{
 ...
 if (wb_Ok.Exists && wb_Ok.VisibleOnScreen == true)
 {
       ...
       Log.Warning("'More information' box not displayed");
}  
//-------------------------------------------------------------------------------
...
function add_comments(INRstarV5, w_new_comment)
{
  ...
  else
  {
       ...
       var w_comments =INRstarV5.Panel(2).Panel("modalDialogBox").Fieldset("EditCommentsFieldset").Form("EditCommentsForm").Textarea("Comments");
