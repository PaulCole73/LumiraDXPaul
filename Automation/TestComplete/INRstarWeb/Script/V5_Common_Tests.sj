...
//===============================================================================
// Patient Demographic Error Messages
function error_message_detail()
{
  ...
  var panelPDAF = panelMCP.Panel("PatientContent").Fieldset("PatientDetailsAddFieldset");
      ...
      var err_text = panelError.innerText;
...
//===============================================================================
//New Treatment Plan Button Error Messages

function error_message_detail_Treatment_plan_add()
{
  var INRstarV5 = set_system();   
